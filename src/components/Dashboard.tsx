...
export default function Dashboard({ events, onNavigate }: DashboardProps) {
  ...
  const thisMonthEvents = monthlyStats[currentMonth]?.events || 0;
  const thisMonthParticipants = monthlyStats[currentMonth]?.participants || 0;
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button 
                ...
                className="border-teal-300 text-teal-700 hover:bg-teal-50 hidden sm:flex"
              >
                Lihat Semua
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {events.length > 0 ? (
                (() => {
                  const topEvent = events.reduce((max, event) => 
